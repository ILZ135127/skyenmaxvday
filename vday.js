...
const happyCanvas = document.getElementById('happyCanvas');
...
happyCanvas.width = 200;
happyCanvas.height = 200;
...
// Draw happy Eevee (celebrating!)
function drawHappyEevee() {
    happyCtx.clearRect(0, 0, happyCanvas.width, happyCanvas.height);
    drawBackground(happyCtx, happyCanvas);
    drawEevee(happyCtx, 80, 80, false);
}
